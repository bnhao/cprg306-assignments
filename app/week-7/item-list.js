...
export default function ItemList({ items }) {
    ...
    return (
        <div>
            <div>
                <button onClick={() => setSortBy("name")} className={nameButtonStyle}>Sort By Name</button>
                <button onClick={() => setSortBy("category")} className={categoryButtonStyle}>Sort By Category</button>
            </div>
